...
const ToastTrackDurationBar_ = ({ duration }: { duration: number }) => {
  ...
  return (
    <div
      ...
      className={cn(
        "absolute bottom-0 left-0 !ml-0 h-1 w-full origin-left animate-trackToastDuration bg-current group-hover/toast:[animation-play-state:paused] group-focus/toast:[animation-play-state:paused]",
        {
